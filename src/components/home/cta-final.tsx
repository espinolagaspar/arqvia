    ...
    <section className="section-padding relative overflow-hidden bg-[#0D0D0D]">
      ...
      <div className="container-ef relative text-center">
        ...
        >
          ...
          {/* Headline */}
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light tracking-[-0.025em] text-ef-white mb-5 max-w-3xl mx-auto">
            Diseñemos tu{" "}
            <span className="font-semibold">próximo espacio</span>
          </h2>

          <p className="text-base text-ef-dim max-w-lg mx-auto mb-12 leading-relaxed font-light">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href="/cotizacion"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-sm border border-ef-border hover:border-white/20 text-ef-dim hover:text-ef-white font-light text-base transition-all duration-300 group"
            >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-center gap-6 mt-14 pt-10 border-t border-ef-border"
          >
            {[
              "Diseño 3D gratis",
              ...
              <div key={item} className="flex items-center gap-2 text-xs text-ef-dim font-light">
                <div className="w-1 h-1 rounded-full bg-ef-dim/40" />
                {item}
              </div>
            ))}
          </motion.div>
